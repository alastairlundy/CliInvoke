...
- **Resource disposal**: Refer to the Resource Cleanup section in `README.md` for guidance on disposing key types: `ProcessConfiguration`, `IExternalProcess`, `UserCredential`, `UserCredentialSpec`, `PipedProcessResult`.
