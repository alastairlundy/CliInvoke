...
### Removals
See [Removed classes](/migration-guides/v1-to-v2/Removed-Classes.md) for all interfaces and classes removed in v2 and their replacements.

See [Removed methods](/migration-guides/v1-to-v2/Removed-Methods.md) for all methods removed in v2 and their replacements.

### Method Signature Changes
See [Method Signature Changes](/migration-guides/v1-to-v2/Method-Signature-Changes.md) for all method signature changes for retained methods from v1 to v2.
