...
- `GLOSSARY.md` at the repository root contains the core domain language and concepts
...
- `improve-codebase-architecture` reads `GLOSSARY.md` to understand domain terminology
- `diagnose` consults `GLOSSARY.md` for context during troubleshooting
...
- Per-context `GLOSSARY.md` files in subdirectories
