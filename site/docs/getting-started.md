...
> `IExternalProcess` when you need process-level control. See [DESIGN_PATTERNS.md](DESIGN_PATTERNS.md) for a
> [Which pattern should I use?](DESIGN_PATTERNS.md#which-invocation-pattern-should-i-use) decision tree.
