...
///  <para><b>Note for Implementers:</b> Implementations should return a valid <see cref="FileInfo"/> file or throw <see cref="System.IO.FileNotFoundException"/> if resolution fails.</para>
/// </remarks>
