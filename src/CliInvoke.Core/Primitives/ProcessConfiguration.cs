...
public class ProcessConfiguration : IEquatable<ProcessConfiguration>
{
    ...
    ///     To pass an argument list, set <see cref="ArgumentList"/> via the object initialiser.
    /// </remarks>
    ...
    ///     rejected with an <see cref="ArgumentNullException"/>. Entries may be empty
    ///     strings; a single empty-string entry is passed to the child process verbatim.
    /// </remarks>
