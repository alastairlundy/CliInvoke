...
public static class AddCustomResultValidatorsExtensions
{
    extension(IServiceCollection services)
    {
        ...
        ///     An array of functions that take a TProcessResult as input and return a boolean indicating
        ///     whether
        ///     the validation passes or fails for that specific rule. Each function represents a single
        ///     validation rule.
        /// </param>
        /// <param name="serviceLifetime">
        ///     The lifetime scope for the validator service in the service collection. Valid values are
        ///     Scoped,
        ///     Singleton, and Transient. Defaults to Scoped if not specified.
        /// </param>
        /// <returns>
        ///     The modified IServiceCollection object, which now includes the added validator services for
        ///     validation rules.
        /// </returns>
        /// <exception cref="ArgumentOutOfRangeException">
        ///     Thrown if an invalid value is provided for 'serviceLifetime'. Valid values are Scoped,
        ///     Singleton, and Transient. If an unsupported or unknown value is passed, this exception will be
        ///     thrown.
        /// </exception>
        ...
        ///     The type of validator implementing the IProcessResultValidator interface for the given process
        ///     result type.
        /// </typeparam>
        ...
        /// </returns>
        /// <exception cref="ArgumentOutOfRangeException">
        ///     Thrown if an invalid value for 'serviceLifetime' is provided. Valid values are Scoped,
