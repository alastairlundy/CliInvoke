...
/// </summary>
public class ClassicPowershellProcessInvoker : IProcessInvoker
{
    ...
    {
        ProcessConfiguration runnerProcess = _runnerProcessCreator.
            CreateRunnerProcess(new ProcessConfiguration(processStartInfo,
    ...
    [SupportedOSPlatform("windows")]
#endif
    public async Task<PipedProcessResult> ExecutePipedProcessAsync(ProcessConfiguration processConfiguration,
        CancellationToken cancellationToken = default)
    {
        ProcessConfiguration runnerProcess = _runnerProcessCreator.CreateRunnerProcess(processConfiguration);
