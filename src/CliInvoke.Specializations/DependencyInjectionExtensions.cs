...
public static class DependencyInjectionExtensions
{
    ...
    /// </exception>
    public static IServiceCollection AddCliInvokeSpecializations(
    ...
    ///     <see cref="PowerShellMiddlewareOptions.Default"/> when no
    ///     <see cref="PowerShellMiddlewareOptions"/> is registered.
    /// </remarks>
    /// <param name="services">The service collection to add to.</param>
    /// <param name="lifetime">The service lifetime to register the middleware with.</param>
    private static void RegisterPlatformMiddleware(this IServiceCollection services, ServiceLifetime lifetime)
    {
